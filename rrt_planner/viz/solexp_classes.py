...
surface_t = Tuple[float, float, float, float]
...
class Experience:
	...
	def __init__(self):
		self.dim: surface_t = (0, 0, 0, 0)
		self.title: str = "title"
		self.start: point_t = (0, 0)
		self.goal: surface_t = (0, 0, 0, 0)
		self.obstacles= []

	def configFromFile(self, filename: str) -> None:
		"""
	...
	def display(self, show=True) -> Tuple[plt.Figure, plt.Axes]:
		"""
...
class Solution:
	...
	def configFromFile(self, solFileName: str) -> None:
		"""
		load experience and stores it into a experience class
		"""
	...
	def display(self, displayTree=True, displayPath=True) -> Tuple[plt.Figure, plt.Axes]:

...
template <class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::getNearestVertex(State &stateIn, Vertex<State, Trajectory, System> *&vertexPointerOut)
{
...
template <class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::getNearVertices(State &stateIn, std::vector<Vertex<State, Trajectory, System> *> &vectorNearVerticesOut)
{
...
RRTstar::Planner<State, Trajectory, System>::insertTrajectory(Vertex<State, Trajectory, System> &vertexStartIn, Trajectory &trajectoryIn)
{
...
template <class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::insertTrajectory(Vertex<State, Trajectory, System> &vertexStartIn, Trajectory &trajectoryIn, Vertex<State, Trajectory, System> &vertexEndIn)
{
...
template <class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::findBestParent(State &stateIn, std::vector<Vertex<State, Trajectory, System> *> &vectorNearVerticesIn, Vertex<State, Trajectory, System> *&vertexBest, Trajectory &trajectoryOut, bool &exactConnection)
{
...
template <class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::updateBranchCost(Vertex<State, Trajectory, System> &vertexIn, int depth)
{
...
template <class State, class Trajectory, class System>
int RRTstar::Planner<State, Trajectory, System>::rewireVertices(Vertex<State, Trajectory, System> &vertexNew, std::vector<Vertex<State, Trajectory, System> *> &vectorNearVertices)
{
